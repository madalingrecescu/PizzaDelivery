...
// WithDefaults hydrates default values in the post login params (not the query_users body).
//
...
// SetDefaults hydrates default values in the post login params (not the query_users body).
//
// All values with no default are reset to their zero value.
...
// WithBody adds the body to the post login params
func (o *PostLoginParams) WithBody(body PostLoginBody) *PostLoginParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post login params
func (o *PostLoginParams) SetBody(body PostLoginBody) {
	o.Body = body
}
