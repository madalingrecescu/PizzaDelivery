...
// Build a url path and query_users string
...
// String returns the string representation of the path with query_users string
func (o *PostLoginURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query_users string
